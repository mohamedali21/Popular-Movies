...
public class TopRatedFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        fetchMovies(recyclerView);
            ...
            MovieAdapter movieAdapter = new MovieAdapter(movieHelper1.getMovies("top_rated"), getActivity());
    ...
    public void fetchMovies(final RecyclerView recyclerView){
        ...
        fetchMovieTask.setNetworkResponse(new NetworkResponse() {
            ...
            public void OnSuccess(final List<MovieModel> mstring) {
                MovieAdapter movieAdapter =new MovieAdapter(mstring,getActivity());
                recyclerView.setAdapter(movieAdapter);
            }
        });
